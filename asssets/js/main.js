// ================= INTRO ANIMACIÓN =================
// al pulsar el botón, se oculta la pantalla de introducción
document.getElementById("enterBtn").addEventListener("click", function() {
    document.getElementById("introScreen").classList.add("hidden");
});

// captar el elemento <canvas> donde pintaremos
const canvas = document.getElementById('chaosCanvas');
const ctx = canvas.getContext('2d'); // obtener el contexto 2D

// función que dibuja todo el escenario de una sola pasada
function drawApp() {
    ctx.clearRect(0, 0, canvas.width, canvas.height); // limpiar la superficie
    ...
    // se generan 90 estrellas con posiciones y radios aleatorios
    for(let i=0; i<90; i++) {
        drawStar(
    ...
    // Pilas de fichas y dados en posiciones fijas/aleatorias
    const chipPositions = [
...
// dibuja el fondo oscuro y el degradado que simula el suelo
function drawStage() {
...
// crea las cortinas laterales y la franja ondulada superior
...
// pinta un símbolo de palo en x,y con rotación aleatoria
...
// despliega un número de cuadrados de colores semi transparentes
...
// dibuja una máscara con gradiente y expresión feliz/triste
...
// focos dibujados como grandes gradients radiales
...
// carta blanca con valor y borde, se rota para simular apilada
...
// pila de fichas formadas por elipses superpuestas
...
// estrella de 5 puntas creada mediante rotaciones
...
// ================= INTRO =================
// repetición del listener de entrada (idéntico al primero)
document.getElementById("enterBtn").addEventListener("click", function() {
    document.getElementById("introScreen").classList.add("hidden");
});

// ================= FRASES ALEATORIAS =================
// arreglo de frases y selección aleatoria
const phrases = [
    "Todo es espectáculo.",
...
// ================= ANIMACIÓN SCROLL =================
// al hacer scroll, comprueba la posición de la sección y añade clase
...
// arrancar el dibujo cuando carga la ventana
